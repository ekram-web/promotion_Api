                    ...
                    @forelse($heros as $hero)
                        <tr class="hover:bg-blue-50 transition">
                            <td class="px-6 py-4 align-top">
                                @if($hero->image)
                                    <img src="{{ asset('storage/' . $hero->image) }}" alt="Hero Image" class="w-20 h-12 object-cover rounded shadow border border-gray-200">
                                @else
                                    <span class="inline-block w-20 h-12 bg-gray-100 text-gray-400 flex items-center justify-center rounded">No Image</span>
                                @endif
                            </td>
                            <td class="px-6 py-4 align-top text-gray-800 text-sm">{{ $hero->title }}</td>
                            <td class="px-6 py-4 align-top text-gray-800 text-sm">{{ $hero->subtitle }}</td>
